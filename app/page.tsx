      ...
      <main className="flex-1 w-full max-w-[1240px] mx-auto px-6 sm:px-8 py-12 sm:py-20 space-y-28 sm:space-y-36">
        ...
        <section aria-labelledby="hero-title" className="pt-4 sm:pt-10">
          <div className="max-w-4xl">
            {/* Top metadata */}
            <div className="flex flex-wrap items-center gap-3 font-mono text-xs text-[var(--muted)] mb-6 sm:mb-8">
              <span className="text-[var(--ink)] font-semibold">Manchester, UK</span>
              <span className="text-[var(--line-strong)]">/</span>
              <span>Senior Software Engineer</span>
              <span className="text-[var(--line-strong)]">/</span>
              <span className="text-[var(--accent)] font-medium">Payment, Platform &amp; Wallet Infrastructure</span>
            </div>
            ...
            <div className="mt-6 sm:mt-8 space-y-4 max-w-2xl">
              ...
              <p className="text-sm sm:text-base text-[var(--muted)] leading-relaxed">
                ...
                and writing about system ownership and product architecture.
              </p>
            </div>
            ...
            <div className="mt-8 sm:mt-10 flex flex-wrap items-center gap-4">
              <a
                href="#work"
                className="px-6 py-3 border border-[var(--ink)] bg-[var(--ink)] text-[var(--paper)] hover:bg-[var(--accent)] hover:border-[var(--accent)] text-xs font-mono tracking-wider transition-colors duration-150 inline-flex items-center gap-2"
              >
              ...
              <a
                href="#writing"
                className="px-6 py-3 border border-[var(--line)] bg-[var(--paper)] text-[var(--ink)] hover:border-[var(--ink)] text-xs font-mono tracking-wider transition-colors duration-150 inline-flex items-center gap-2"
              >
        ...
        <section id="work" aria-labelledby="work-title">
          <SectionLabel number="01" label="Selected Work &amp; Systems" className="mb-8" />

          <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-10 pb-6 border-b border-[var(--line)]">
            <div>
              <h2
                id="work-title"
        ...
        <section id="lifecycle" aria-labelledby="lifecycle-title">
          <SectionLabel number="02" label="Engineering Methodology" className="mb-8" />

          <div className="mb-10 pb-6 border-b border-[var(--line)] flex flex-col md:flex-row md:items-end justify-between gap-4">
            <div>
              <h2
                id="lifecycle-title"
                className="font-serif text-3xl sm:text-4xl text-[var(--ink)] font-normal"
              ...
              <p className="text-sm sm:text-base text-[var(--ink-secondary)] mt-2 max-w-2xl leading-relaxed">
        ...
        <section id="walletkit" aria-labelledby="walletkit-title">
          <SectionLabel number="03" label="Featured System Infrastructure" className="mb-8" />
          ...
          <div className="mb-10 pb-6 border-b border-[var(--line)] flex flex-col md:flex-row md:items-end justify-between gap-4">
            <div>
              ...
              <p className="text-base sm:text-lg text-[var(--ink-secondary)] mt-2 max-w-2xl">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-1.5 px-4 py-2 border border-[var(--ink)] text-xs font-mono text-[var(--ink)] hover:bg-[var(--accent)] hover:border-[var(--accent)] hover:text-[var(--paper)] transition-colors"
            >
        ...
        <section id="writing" aria-labelledby="writing-title">
          <SectionLabel number="04" label="Writing &amp; Research" className="mb-8" />
        ...
        <section id="about" aria-labelledby="about-title">
          <SectionLabel number="05" label="About Emmanuel" className="mb-8" />

          <div className="border border-[var(--line)] bg-[var(--paper)] p-6 sm:p-12">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start">
              ...
              {/* Right timeline */}
              <div className="lg:col-span-5 bg-[var(--paper-card)] p-5 border border-[var(--line)]">
                <span className="font-mono text-xs uppercase tracking-wider text-[var(--muted)] block mb-4 border-b border-[var(--line)] pb-2">
                  Trajectory &amp; Focus Evolution
                </span>

                <div className="relative pl-6 space-y-5 before:absolute before:left-2 before:top-2 before:bottom-2 before:w-px before:bg-[var(--line-strong)]">
        ...
        <section id="contact" aria-labelledby="contact-title">
          <SectionLabel number="06" label="Direct Channels" className="mb-8" />

          <div className="border border-[var(--ink)] bg-[var(--paper-card)] p-8 sm:p-12 flex flex-col md:flex-row md:items-center justify-between gap-8">
            ...
            <div className="flex flex-col sm:flex-row md:flex-col gap-3">
              <a
                ...
                className="px-6 py-3 border border-[var(--ink)] bg-[var(--ink)] text-[var(--paper)] hover:bg-[var(--accent)] hover:border-[var(--accent)] text-xs font-mono text-center tracking-wider transition-colors"
              >
